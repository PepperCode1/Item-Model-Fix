...
public class ItemModelUtil {
	...
	public static boolean isPixelAlwaysTransparent(Sprite sprite, int x, int y) {
	...
	public static boolean doesPixelHaveEdge(Sprite sprite, int x, int y, PixelDirection direction) {
