...
public class SodiumFluidRendererMixin {
	...
	@ModifyConstant(method="(Lnet/minecraft/class_1920;Lnet/minecraft/class_3610;Lnet/minecraft/class_2338;Lme/jellysquid/mods/sodium/client/model/quad/sink/ModelQuadSinkDelegate;)Z", constant={@Constant(floatValue=0.001F)})
	...
	@ModifyConstant(method="(Lnet/minecraft/class_1920;Lnet/minecraft/class_3610;Lnet/minecraft/class_2338;Lme/jellysquid/mods/sodium/client/model/quad/sink/ModelQuadSinkDelegate;)Z", constant={@Constant(floatValue=0.999F)})
